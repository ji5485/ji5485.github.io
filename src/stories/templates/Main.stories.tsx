...
const MainProps = {
  ...
  iconList: [
    { href: 'https://github.com/ji5485', type: 'github', size: 25 },
    { href: 'https://www.instagram.com/?hl=ko', type: 'instagram', size: 25 },
    { href: 'https://www.facebook.com/', type: 'facebook', size: 25 },
  ]
};
